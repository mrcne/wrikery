...
type KeyMap struct {
	...
	Comment, CommentEditor, LogTime, Status, Assignee, Dates, EditTitle, Importance, Open key.Binding
...
func defaultKeyMap() KeyMap {
	return KeyMap{
		...
		Status: b("s", "status", "s"), Assignee: b("a", "assignee", "a"), Dates: b("d", "dates", "d"), EditTitle: b("e", "title", "e"), Importance: b("p", "importance", "p"),
...
func (k KeyMap) task() []key.Binding {
	return []key.Binding{k.Comment, k.CommentEditor, k.LogTime, k.Status, k.StatusPrev, k.StatusNext, k.Assignee, k.Dates, k.EditTitle, k.Importance, k.Open, k.CopyLink, k.CopyBranch, k.CopyID}
}
